...
public class ForLoops {
    public static void main(String[] args) {
         ...
         * Специальный цикл for ( <инициализация>; <условие>; <продвижение>) { } позволяет все три компонента совместить
         *
         ...
         *              System.out.println(++counter);//неявно двигаем счётчик повторно
         *
